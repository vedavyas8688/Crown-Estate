...
export default function BlogPage() {
  ...
  return (
    <>
      <Seo
        title="Event Planning Blog | Weddings, Corporate Events & Celebrations Bangalore"
        description="Get expert event planning advice, wedding inspiration, venue selection tips, corporate event ideas, family reunion guides, and luxury celebration trends from Crown Estate Bangalore."
        keywords="Wedding Venue Bangalore Blog, Event Planning Tips, Corporate Event Ideas, Reception Venue Bangalore, Anniversary Celebration Venue, Birthday Party Venue Bangalore, Luxury Estate Bangalore"
      />
      <div ref={ref}>
        {/* ============ HERO ============ */}
          ...
          <div className="content">
            <div className="hero-top">
              ...
              <p className="paragraph margin" data-hero-reveal>
                Explore event planning tips, venue guides and celebration ideas
                from the Crown Estate team.
              </p>
