export const serviceDetails = {
  "destination-weddings-and-receptions": {
    slug: "destination-weddings-and-receptions",
    title: "Destination Weddings & Receptions",
    eyebrow: "Wedding Venue in Bangalore",
    ...
    heroParagraph:
      "Celebrate your wedding, nikah ceremony or grand reception at Crown Estate, a premium 4-acre private estate on Airport Road, Bangalore. With expansive lawns, elegant hall space, 20 luxury AC rooms and event-ready amenities, the venue is designed for unforgettable celebrations with comfort, beauty and scale.",
    ...
    inclusions: {
      ...
      list: [
        "4-acre private estate on Airport Road, Bangalore",
        "20 luxury AC rooms for up to 100 guests",
        "Expansive lawns and spacious hall area",
        "Complimentary reception or nikah stage",
        "Complimentary entrance gate setup",
        "Optional complimentary mantap",
        "Chairs and tables for 500 to 800 guests",
        "Swimming pool, children’s play area and multiple kitchens",
      ],
    },
    ...
    testimonial: {
      ...
      quote:
        "“Crown Estate is the kind of venue that gives a wedding both grandeur and comfort. The lawns, rooms and open spaces create a beautiful experience for families and guests.”",
    ...
    packages: [
      {
        ...
        description:
          "A complete venue package for destination weddings, nikah ceremonies and grand receptions in Bangalore.",
      ...
      },
      {
        ...
        description:
          "Ideal for large evening receptions, post-wedding celebrations and family gatherings.",
        price: "On request",
        features: [
      ...
      },
      {
        ...
        description:
          "Best suited for families planning a multi-day wedding stay experience in Bangalore.",
        price: "On request",
        features: [
  ...
  "birthday-and-anniversary-celebrations": {
    slug: "birthday-and-anniversary-celebrations",
    title: "Birthday & Anniversary Celebrations",
    eyebrow: "Private Celebrations",
    teaserImage: "/eventimages/banner3.webp",
    teaserBody:
    ...
    heroParagraph:
      "Make your special day feel grand, personal and memorable at Crown Estate. From milestone birthdays to anniversary retreats, our luxury private estate on Airport Road, Bangalore offers the perfect setting for celebrations with family and friends.",
    ...
    inclusions: {
      ...
      list: [
        ...
        "Anniversary events and family dinners",
        "Private lawn celebrations",
        "Poolside and outdoor event experiences",
        "Luxury stay for family and close guests",
        "Children’s play area for family-friendly events",
        "Multiple kitchens for smooth catering coordination",
        "Spacious setup options for decor, music and entertainment",
      ],
    },
    ...
    testimonial: {
      flower: "/images/flower_2.png",
      quote:
        "“The estate has the right mix of privacy, space and comfort. It is a beautiful place for family celebrations, birthdays and anniversary events.”",
      author: "Guest Experience",
    },
    ...
    packages: [
      {
        ...
        description:
          "Ideal for grand birthday parties, themed events and family celebrations in Bangalore.",
        price: "On request",
        features: [
          "Lawn and hall area options",
          "Guest seating support",
          "Stay options for family members",
          "Poolside and outdoor celebration spaces",
        ],
      },
      {
        eyebrow: "Anniversary",
        name: "Anniversary Retreat",
        description:
          "A premium private estate experience for couples and families celebrating milestone anniversaries.",
        price: "On request",
        featured: true,
        features: [
          "Luxury stay arrangement",
          "Private celebration space",
          "Dining and catering support areas",
          "Peaceful estate ambience",
        ],
      },
      {
        eyebrow: "Grand",
        name: "24-Hour Private Event",
        description:
          "Best suited for large family celebrations with stay and event access.",
        price: "₹5.5 Lakhs + 18% GST",
        features: [
          "20 AC rooms for up to 100 guests",
          "Lawns and hall area",
          "Tables and chairs for 500 to 800 guests",
  ...
  "family-get-togethers-and-reunions": {
    ...
    heroParagraph:
      "Reconnect, celebrate and spend quality time together at Crown Estate, a premium private estate on Airport Road, Bangalore. With stay facilities, open lawns, poolside spaces and family-friendly amenities, it is perfect for reunions, get-togethers and private group celebrations.",
    ...
    inclusions: {
      ...
      list: [
        "20 luxury AC rooms for family stay",
        "Accommodation for up to 100 guests",
        "Large lawns for outdoor gatherings",
        "Hall area for indoor functions",
        "Swimming pool for leisure time",
        "Children’s play area",
        "Multiple kitchens for catering support",
        "Ideal for reunions, get-togethers and weekend family stays",
      ],
    },
    ...
    testimonial: {
      flower: "/images/flower_5.png",
      quote:
        "“Crown Estate feels perfect for families because there is space to celebrate, space to relax and enough room for everyone to stay comfortably.”",
      author: "Guest Experience",
    },
    ...
    packages: [
      {
        ...
        description:
          "A comfortable estate experience for family gatherings and private celebrations.",
        price: "On request",
        features: [
          "Lawn and hall access",
          "Stay options for family guests",
          "Pool and play area access",
          "Dining and catering support spaces",
        ],
      },
      {
        eyebrow: "Reunion",
        name: "Family Reunion Stay",
        description:
          "Ideal for large families planning a reunion with overnight stay in Bangalore.",
        price: "On request",
        featured: true,
        features: [
          "20 AC rooms",
          "Stay for up to 100 guests",
      ...
      {
        eyebrow: "Full Day",
        name: "24-Hour Estate Access",
        description:
          "Best for large family gatherings with celebration and stay requirements.",
        price: "₹5.5 Lakhs + 18% GST",
        features: [
          "20 AC rooms",
          "Lawns and hall area",
  ...
  "luxury-weekend-getaways": {
    ...
    heroParagraph:
      "Escape into a private estate experience at Crown Estate, a spacious 4-acre property on Airport Road, Bangalore. Perfect for families, friends and private groups, the estate offers luxury AC rooms, swimming pool, children’s play area, lawns and peaceful spaces for a refreshing weekend stay.",
    ...
    inclusions: {
      ...
      list: [
        "20 luxury AC rooms",
        "Stay capacity for up to 100 guests",
        "Swimming pool for leisure and relaxation",
        "Children’s play area",
        "Expansive lawns for outdoor activities",
        "Hall area for indoor gatherings",
        "Multiple kitchens for food arrangements",
        "Ideal for weekend retreats, group stays and private celebrations",
      ],
    },
    ...
    testimonial: {
      flower: "/images/flower_5.png",
      quote:
        "“The estate is spacious, private and comfortable, making it a great choice for weekend stays, family retreats and group celebrations near Bangalore.”",
      author: "Guest Experience",
    },
    ...
    packages: [
      {
        ...
        description:
          "A private estate stay experience for families, friends and groups.",
        price: "On request",
        features: [
          "AC room stay",
          "Pool access",
      ...
      },
      {
        ...
        description:
          "Ideal for private groups looking for a comfortable weekend stay near Bangalore.",
        price: "On request",
        featured: true,
        features: [
          "20 AC rooms",
      ...
      {
        eyebrow: "24 Hours",
        name: "Full Estate Experience",
        description:
          "Best for weekend celebrations, group events and private retreats.",
        price: "₹5.5 Lakhs + 18% GST",
        features: [
          "20 AC rooms",
          "Lawns and hall area",
          "Tables and chairs for large gatherings",
          "Multiple kitchens",
        ],
      },
    ],
  ...
  "exhibitions-and-fashion-shows": {
    ...
    heroParagraph:
      "Create an impressive showcase at Crown Estate, a spacious 4-acre venue on Airport Road, Bangalore. From fashion shows and clothing exhibitions to car displays, lifestyle fairs and premium brand events, the estate offers flexible open and covered spaces for high-impact experiences.",
    ...
    inclusions: {
      ...
      flowerClass: "flower---a variant",
      list: [
        "Fashion shows and designer showcases",
        "Clothing exhibitions and lifestyle fairs",
        "Car displays and automobile exhibitions",
        "Product launches and brand activations",
        "Spacious lawns for stall and display layouts",
        "Hall area for indoor event sections",
        "Multiple kitchens for food and hospitality support",
        "Premium Airport Road location in Bangalore",
      ],
    },
    ...
    testimonial: {
      flower: "/images/flower_5.png",
      quote:
        "“The large open spaces and premium estate setting make Crown Estate a strong choice for exhibitions, showcases and brand-led events in Bangalore.”",
      author: "Guest Experience",
    },
    ...
    packages: [
      {
        eyebrow: "Showcase",
        name: "Exhibition Venue Package",
        description:
          "Suitable for lifestyle exhibitions, clothing fairs and curated showcases.",
        price: "On request",
        features: [
          "Lawn and hall area access",
          "Flexible layout planning",
          "Food and hospitality support areas",
          "Premium private venue setting",
        ],
      },
      {
        eyebrow: "Fashion",
        name: "Fashion Show Package",
        description:
          "A premium setup option for fashion shows, designer previews and brand showcases.",
        price: "On request",
        featured: true,
        features: [
          "Stage and seating possibilities",
          "Guest flow planning",
          "Outdoor and indoor event zones",
          "Vendor-friendly setup areas",
        ],
      },
      {
        eyebrow: "Large Format",
        name: "Car & Lifestyle Fair",
        description:
          "Ideal for automobile displays, premium fairs and large-format brand events.",
        price: "On request",
        features: [
          "4-acre property access",
          "Large display-friendly spaces",
          "Entry and movement planning",
          "Custom event setup support",
        ],
      },
    ],
  ...
  "corporate-events-and-conferences": {
    ...
    heroParagraph:
      "Host professional events in a setting that feels premium, spacious and private. Crown Estate on Airport Road, Bangalore is ideal for corporate conferences, team outings, leadership retreats, product launches, award nights and business gatherings with stay options and flexible event spaces.",
    ...
    inclusions: {
      ...
      flowerClass: "flower---a variant",
      list: [
        "Corporate conferences and business meets",
        "Team outings and leadership retreats",
        "Product launches and brand presentations",
        "Award nights and annual celebrations",
        "Hall area for sessions and presentations",
        "Lawns for networking and outdoor activities",
        "20 AC rooms for executive or team stay",
        "Multiple kitchens for catering and hospitality",
      ],
    },
    ...
    testimonial: {
      flower: "/images/flower_5.png",
      quote:
        "“Crown Estate offers the space and privacy companies need for conferences, retreats, product showcases and team events in Bangalore.”",
      author: "Guest Experience",
    },
    ...
    packages: [
      {
        ...
        description:
          "Suitable for business meets, formal conferences and professional gatherings.",
        price: "On request",
        features: [
          "Hall area for sessions",
          "Outdoor networking spaces",
      ...
      },
      {
        ...
        description:
          "Ideal for leadership retreats, team outings and offsite experiences near Bangalore.",
        price: "On request",
        featured: true,
        features: [
          "20 AC rooms",
          "Lawn and poolside spaces",
          "Stay for up to 100 guests",
          "Private estate ambience",
        ],
      },
      {
        eyebrow: "Launch",
        ...
        description:
          "Best suited for product launches, brand presentations and corporate celebrations.",
        price: "On request",
        features: [
          "Stage and seating possibilities",
          "Branding-friendly spaces",
          "Guest flow planning",
          "Large-format event support",
        ],
      },
    ],
